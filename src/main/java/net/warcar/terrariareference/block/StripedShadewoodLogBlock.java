...
public class StripedShadewoodLogBlock extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:striped_shadewood_log")
	public static final Block block = null;

	public StripedShadewoodLogBlock(TerrariaReferenceModElements instance) {
		super(instance, 275);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("striped_shadewood_log");
		}
