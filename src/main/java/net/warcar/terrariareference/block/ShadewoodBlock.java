...
public class ShadewoodBlock extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:shadewood")
	public static final Block block = null;

	public ShadewoodBlock(TerrariaReferenceModElements instance) {
		super(instance, 274);
	}
