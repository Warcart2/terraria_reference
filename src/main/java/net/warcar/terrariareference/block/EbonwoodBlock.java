...
import net.warcar.terrariareference.procedures.EbonwoodOnBlockRightClickedProcedure;
...
public class EbonwoodBlock extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:ebonwood")
	public static final Block block = null;

	public EbonwoodBlock(TerrariaReferenceModElements instance) {
		super(instance, 259);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			ActionResultType result = EbonwoodOnBlockRightClickedProcedure.executeProcedure(
