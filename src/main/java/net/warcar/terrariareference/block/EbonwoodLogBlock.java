...
import net.warcar.terrariareference.procedures.EbonwoodLogOnBlockRightClickedProcedure;
...
public class EbonwoodLogBlock extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:ebonwood_log")
	public static final Block block = null;

	public EbonwoodLogBlock(TerrariaReferenceModElements instance) {
		super(instance, 258);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(1).harvestTool(ToolType.AXE));
			setRegistryName("ebonwood_log");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			ActionResultType result = EbonwoodLogOnBlockRightClickedProcedure.executeProcedure(
