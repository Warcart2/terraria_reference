...
public class StripedShadewoodBlock extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:striped_shadewood")
	public static final Block block = null;

	public StripedShadewoodBlock(TerrariaReferenceModElements instance) {
		super(instance, 276);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("striped_shadewood");
		}
