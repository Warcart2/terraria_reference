...
public class ShadewoodPlanksBlock extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:shadewood_planks")
	public static final Block block = null;

	public ShadewoodPlanksBlock(TerrariaReferenceModElements instance) {
		super(instance, 272);
	}
