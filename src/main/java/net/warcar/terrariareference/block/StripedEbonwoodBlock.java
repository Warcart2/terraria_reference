...
public class StripedEbonwoodBlock extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:striped_ebonwood")
	public static final Block block = null;

	public StripedEbonwoodBlock(TerrariaReferenceModElements instance) {
		super(instance, 266);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("striped_ebonwood");
		}
