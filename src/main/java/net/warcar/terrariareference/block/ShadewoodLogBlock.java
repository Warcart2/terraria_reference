...
public class ShadewoodLogBlock extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:shadewood_log")
	public static final Block block = null;

	public ShadewoodLogBlock(TerrariaReferenceModElements instance) {
		super(instance, 273);
	}
