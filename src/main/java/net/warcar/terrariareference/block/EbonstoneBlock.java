...
import net.warcar.terrariareference.procedures.ExpandCorruptionProcedure;
...
public class EbonstoneBlock extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:ebonstone")
	public static final Block block = null;

	public EbonstoneBlock(TerrariaReferenceModElements instance) {
		super(instance, 65);
	}
