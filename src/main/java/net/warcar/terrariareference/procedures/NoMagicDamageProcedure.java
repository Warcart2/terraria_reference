...
public class NoMagicDamageProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TerrariaReferenceMod.LOGGER.warn("Failed to load dependency entity for procedure NoMagicDamage!");
			return;
		}
		DamageSource source = (DamageSource) dependencies.get("source");
		Entity entity = (Entity) dependencies.get("entity");
		if (source.isMagicDamage() && entity.getPersistentData().getBoolean("nazar")) {
