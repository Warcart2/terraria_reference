...
public class DemonConchRightClickedInAirProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TerrariaReferenceMod.LOGGER.warn("Failed to load dependency entity for procedure DemonConchRightClickedInAir!");
			return;
		}
		...
		entity.getPersistentData().putDouble("ticksDemonTp", 1);
	}
}
