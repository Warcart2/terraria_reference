...
public class NoWitherDamageProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TerrariaReferenceMod.LOGGER.warn("Failed to load dependency entity for procedure NoWitherDamage!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		DamageSource source = (DamageSource) dependencies.get("source");
		if (entity.getPersistentData().getBoolean("milk_sponge") && source == DamageSource.WITHER) {
