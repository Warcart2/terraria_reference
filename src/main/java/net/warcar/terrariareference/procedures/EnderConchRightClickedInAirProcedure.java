...
public class EnderConchRightClickedInAirProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TerrariaReferenceMod.LOGGER.warn("Failed to load dependency entity for procedure EnderConchRightClickedInAir!");
			return;
		}
		...
		entity.getPersistentData().putDouble("ticksEnderTp", 1);
	}
}
