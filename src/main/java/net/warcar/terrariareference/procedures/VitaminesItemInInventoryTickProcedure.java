...
public class VitaminesItemInInventoryTickProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TerrariaReferenceMod.LOGGER.warn("Failed to load dependency entity for procedure VitaminesItemInInventoryTick!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				TerrariaReferenceMod.LOGGER.warn("Failed to load dependency itemstack for procedure VitaminesItemInInventoryTick!");
			return;
		}
		if (dependencies.get("slot") == null) {
			if (!dependencies.containsKey("slot"))
				TerrariaReferenceMod.LOGGER.warn("Failed to load dependency slot for procedure VitaminesItemInInventoryTick!");
			return;
		}
