...
public class RocketBootsItem extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:rocket_boots")
	public static final Item block = null;

	public RocketBootsItem(TerrariaReferenceModElements instance) {
		super(instance, 287);
	}
