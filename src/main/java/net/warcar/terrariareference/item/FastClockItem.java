...
import net.warcar.terrariareference.procedures.FastClockItemInInventoryTickProcedure;
...
public class FastClockItem extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:fast_clock")
	public static final Item block = null;

	public FastClockItem(TerrariaReferenceModElements instance) {
		super(instance, 11);
	}
