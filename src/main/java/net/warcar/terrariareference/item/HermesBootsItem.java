...
public class HermesBootsItem extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:hermes_boots")
	public static final Item block = null;

	public HermesBootsItem(TerrariaReferenceModElements instance) {
		super(instance, 284);
	}
