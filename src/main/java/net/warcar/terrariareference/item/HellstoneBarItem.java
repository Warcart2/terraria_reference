...
public class HellstoneBarItem extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:hellstone_bar")
	public static final Item block = null;

	public HellstoneBarItem(TerrariaReferenceModElements instance) {
		super(instance, 47);
	}
