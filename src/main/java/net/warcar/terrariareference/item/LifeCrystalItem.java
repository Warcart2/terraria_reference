...
import net.warcar.terrariareference.procedures.LifeCrystalRightclickedProcedure;
...
public class LifeCrystalItem extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:life_crystal")
	public static final Item block = null;

	public LifeCrystalItem(TerrariaReferenceModElements instance) {
		super(instance, 55);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			LifeCrystalRightclickedProcedure
