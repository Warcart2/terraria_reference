...
import net.warcar.terrariareference.procedures.MagicMirrorRightClickedInAirProcedure;
...
public class MagicMirrorItem extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:magic_mirror")
	public static final Item block = null;

	public MagicMirrorItem(TerrariaReferenceModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Gaze in the mirror to return home"));
		}
