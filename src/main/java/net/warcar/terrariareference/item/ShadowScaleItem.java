...
public class ShadowScaleItem extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:shadow_scale")
	public static final Item block = null;

	public ShadowScaleItem(TerrariaReferenceModElements instance) {
		super(instance, 51);
	}
