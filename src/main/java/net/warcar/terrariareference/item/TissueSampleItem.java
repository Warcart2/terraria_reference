...
public class TissueSampleItem extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:tissue_sample")
	public static final Item block = null;

	public TissueSampleItem(TerrariaReferenceModElements instance) {
		super(instance, 52);
	}
