...
import net.warcar.terrariareference.procedures.VitaminesItemInInventoryTickProcedure;
...
public class VitaminesItem extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:vitamines")
	public static final Item block = null;

	public VitaminesItem(TerrariaReferenceModElements instance) {
		super(instance, 12);
	}
