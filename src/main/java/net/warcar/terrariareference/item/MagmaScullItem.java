...
public class MagmaScullItem extends TerrariaReferenceModElements.ModElement {
	@ObjectHolder("terraria_reference:magma_scull")
	public static final Item block = null;

	public MagmaScullItem(TerrariaReferenceModElements instance) {
		super(instance, 18);
	}
