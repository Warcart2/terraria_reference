...
import net.warcar.terrariareference.procedures.UseMountOnKeyPressedProcedure;
...
public class UseMountKeyBinding extends TerrariaReferenceModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public UseMountKeyBinding(TerrariaReferenceModElements instance) {
		super(instance, 327);
	...
	public void initElements() {
		keys = new KeyBinding("key.terraria_reference.use_mount", GLFW.GLFW_KEY_R, "key.categories.movement");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			UseMountOnKeyPressedProcedure.executeProcedure(
